...
const PATH_SOCIAL_ACCOUNT = path.resolve(
  __dirname,
  "../../onchain/target/dev/afk_ignite_PeggedCoin.contract_class.json"
);
const PATH_SOCIAL_ACCOUNT_COMPILED = path.resolve(
  __dirname,
  "../../onchain/target/dev/afk_ignite_PeggedCoin.compiled_contract_class.json"
);

/** @TODO spec need to be discuss. This function serve as an example */
export const createPeggedCoin = async (
  name: string,
  symbol: string,
  recipient: string,
  decimals: number,
